...
const NAV_ITEMS = [
  ...
  { label: 'CRM / Contacts',path: '/contacts',      icon: '📋', minRole: 1 },
  { label: 'Members',       path: '/members',       icon: '👥', minRole: 1 },
  { label: 'Profile',       path: '/profile',       icon: '👤', minRole: 0 },
  { label: 'Admin Panel',   path: '/admin',         icon: '⚙️', minRole: 2 },
];
        ...
        return (
          <button
            ...
            className={cn(
              ...
              active ? 'bg-red-50 text-york-600 font-semibold' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-900'
            )}
          >
      ...
      {isMobileOpen && (
        <>
          ...
          <div
            ...
            className="md:hidden fixed left-0 top-0 bottom-0 w-72 bg-white z-50 flex flex-col shadow-xl animate-[slideInLeft_0.25s_ease-out]"
          >
